...
/**
 Base class for all thepizzaplacepart4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the thepizzaplacepart4 view hierarchy (such as wrapped iOS UIViews) was touched.
