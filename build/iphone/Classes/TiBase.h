...
// in simulator we redefine to format for thepizzaplacepart4 Developer console
...
{\
	NSString * exceptionName = [@"org.thepizzaplacepart4." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.thepizzaplacepart4";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIthepizzaplacepart4NativeItemNone = -1, 
	UIthepizzaplacepart4NativeItemSpinner = -2,
	UIthepizzaplacepart4NativeItemProgressBar = -3,
	
	UIthepizzaplacepart4NativeItemSlider = -4,
	UIthepizzaplacepart4NativeItemSwitch = -5,
	UIthepizzaplacepart4NativeItemMultiButton = -6,
	UIthepizzaplacepart4NativeItemSegmented = -7,
	
	UIthepizzaplacepart4NativeItemTextView = -8,
	UIthepizzaplacepart4NativeItemTextField = -9,
	UIthepizzaplacepart4NativeItemSearchBar = -10,
	
	UIthepizzaplacepart4NativeItemPicker = -11,
	UIthepizzaplacepart4NativeItemDatePicker = -12,
	
	UIthepizzaplacepart4NativeItemInfoLight = -13,
	UIthepizzaplacepart4NativeItemInfoDark = -14,
	
	UIthepizzaplacepart4NativeItemDisclosure = -15,
	
	UIthepizzaplacepart4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all thepizzaplacepart4 instances of
