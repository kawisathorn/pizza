...
static NSString * const kthepizzaplacepart4Javascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_thepizzaplacepart4Injection
{
	...
	[html appendString:kthepizzaplacepart4Javascript];
...
{
	// attempt to make well-formed HTML and inject in our thepizzaplacepart4 bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _thepizzaplacepart4Injection]];
