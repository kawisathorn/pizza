...
//Rare exceptions to indicate a bug in the _thepizzaplacepart4 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for thepizzaplacepart4 proxies.
 */
