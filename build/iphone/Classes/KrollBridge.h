...
@interface thepizzaplacepart4Object : KrollCoverageObject {
#else
@interface thepizzaplacepart4Object : KrollObject {
#endif
@private
...
extern NSString * thepizzaplacepart4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	thepizzaplacepart4Object *_thepizzaplacepart4;
    KrollObject* console;
	BOOL shutdown;
