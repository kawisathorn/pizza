...
/**
 The base class for all thepizzaplacepart4 modules
 */
...
/**
 thepizzaplacepart4 Platform calls this method on startup.
 */
-(void)startup;

/**
 thepizzaplacepart4 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 thepizzaplacepart4 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 thepizzaplacepart4 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 thepizzaplacepart4 Platform calls this method on resume.
 @param sender The sender of the event.
 */
