 ...
 * Copyright (c) 2009-2011 by thepizzaplacepart4, Inc. All Rights Reserved.
...
//@interface thepizzaplacepart4Object : NSObject
//@end

@interface thepizzaplacepart4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[thepizzaplacepart4Object class]])
		{
			for (NSString *key in [[(thepizzaplacepart4Object*)o modules] allKeys])
			{
